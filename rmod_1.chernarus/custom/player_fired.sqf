...
//Smoke Grenade
if (_ammo isKindOf "SmokeShell" || ((daytime < 6 || daytime > 20)&&(_ammo isKindOf "RoadFlare"))) then { //GHK add flares chase if at night time (does this work when only daylight is selected?
