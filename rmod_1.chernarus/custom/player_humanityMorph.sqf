...
_survival_time  = player getVariable ["survival_time",0]; //GHK
...
player setVariable ["survival_time",_survival_time,true]; //GHK
...
//GHK make sure the player is going to be where they were before they switched
player SetDir (_worldspace select 0);
