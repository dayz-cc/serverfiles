...
if (_inCombat) then {
	...
	_ebayrandomspawn = [[10845.3,2701.37,1000.0], [9479.41,1960.8,1000.0], [10497.3,2016.5,1000.0], [10214.1,2411.58,1000.0], [10432.7,2047.76,1000.0]] call BIS_fnc_selectRandom;
