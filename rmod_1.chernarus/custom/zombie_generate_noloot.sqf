private["_position","_doLoiter","_unitTypes","_isNoone","_loot","_array","_agent","_type","_radius","_method","_nearByPlayer","_attempt","_myDest","_newDest","_lootType","_3dpos"];
...
//diag_log (" ghk noloot Spawned: " + str([_type, _position, [], _radius, _method]));
_agent = createAgent [_type, _3dpos, [], _radius, _method];

if (_doLoiter) then {
	_agent setPosATL _3dpos; //_position;
