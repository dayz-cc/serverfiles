...
diag_log ("trapbear pickup disabled1");
_playerID = getPlayerUID player;
_text = getText (configFile >> _type >> _classname >> "displayName");

_holder setVariable["claimed",_playerID,true];

if(_holder isKindOf "BearTrap_DZ") exitwith {

diag_log ("trapbear pickup disabled2");

//ghk
//_objectID 	= _holder getVariable["ObjectID","0"];
//_objectUID	= _holder getVariable["ObjectUID","0"];
/*
...
cutText ["This trap is stuck","PLAIN DOWN",2];
};
