...
//GHK Add stash objects
_objects = nearestObjects [getPosATL player, ["Car", "Helicopter", "Motorcycle", "Ship", "TentStorage","Land_Fire_DZ"], 10];
{
	if(_x isKindOf "Land_Fire_DZ") then {
		_ownerID = _x getVariable ["characterID","0"];
		if(_ownerID !="0") then { //stash object
