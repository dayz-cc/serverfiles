...
if (!show_survival) then {
   ...
   manatee_craft_menu_sur set [count manatee_craft_menu_sur, player addaction [("<t color=""#FFC726"">" + ("    Hunting Knife") +"</t>"),"crafting\oven.sqf",[[1,"Hunting Knife","ItemKnife",1],[[0,"ItemTrashRazor",4,"Razor"]]],94,false,false,"",_restriction]];
	...
	manatee_craft_menu_sur set [count manatee_craft_menu_sur, player addaction [("<t color=""#FFC726"">" + ("    Old Camping Tent (from Ghillie Suit)") +"</t>"),"crafting\oven.sqf",[[0,"Old Camping Tent","ItemTent",1],[[0,"ItemTankTrap",1,"Tank Trap Kit"],[0,"ItemWire",1,"Wire Kit"],[0,"Skin_Sniper1W_DZN",1,"Ghillie Suit"]]],94,false,false,"",_restriction]];
	manatee_craft_menu_sur set [count manatee_craft_menu_sur, player addaction [("<t color=""#FFC726"">" + ("    Old Camping Tent (from Camo Clothing)") +"</t>"),"crafting\oven.sqf",[[0,"Old Camping Tent","ItemTent",1],[[0,"ItemTankTrap",1,"Tank Trap Kit"],[0,"ItemWire",1,"Wire Kit"],[0,"Skin_CamoWinter_DZN",1,"Camo Clothing"]]],94,false,false,"",_restriction]];
	manatee_craft_menu_sur set [count manatee_craft_menu_sur, player addaction [("<t color=""#FFC726"">" + ("    Old Camping Tent (from Soldier Clothing)") +"</t>"),"crafting\oven.sqf",[[0,"Old Camping Tent","ItemTent",1],[[0,"ItemTankTrap",1,"Tank Trap Kit"],[0,"ItemWire",1,"Wire Kit"],[0,"Skin_CamoWinterW_DZN",1,"Soldier Clothing"]]],94,false,false,"",_restriction]];
