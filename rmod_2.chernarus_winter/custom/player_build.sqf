private["_location","_isOk","_dir","_classname","_item","_id"];
...
//GHK Make ItemSandbag the proxy for creating Zombie Bait Siren:
if(_item =="ItemSandbag") exitWith {
	_id = [] execVM "custom\setAlarm.sqf";
};
