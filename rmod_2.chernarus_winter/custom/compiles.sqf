...
player_chopWood =			compile preprocessFileLineNumbers "custom\player_chopWood.sqf"; //GHK surfacetype check does not work on chernarus_winter, so check for trees within 15m instead.
dzn_fnc_snowfall = 	compile preprocessFileLineNumbers "dayz_code\init\fn_dzn_snowfall.sqf"; //GHK
player_temp_calculation	=	compile preprocessFileLineNumbers "dayz_code\init\fn_temperatur.sqf";		// GHK New Snow Temperatur System	//TeeChange
